...
public final class admin_005fservice_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Service-PSF</title>\n");
      out.write("<script type=\"text/javascript\">\n");
      out.write("            function validateform(){\n");
      out.write("               var a = document.forms[\"reg\"][\"servicename\"].value;\n");
      out.write("               var b = document.forms[\"reg\"][\"doc\"].value;\n");
      out.write("               if (a == null || a == \"\") {\n");
      out.write("                 alert(\"Service field cannot be left\");\n");
      out.write("                 return false;\n");
      out.write("            }\n");
      out.write("            else if (b == null || b == \"\") {\n");
      out.write("                 alert(\"Document field cannot be left\");\n");
      out.write("                 return false;\n");
      out.write("            }\n");
      out.write("            else {\n");
      out.write("                alert(\"Your Service is inserted\");\n");
      ...
      out.write("    <form name=\"reg\" action=\"ServiceServlet\">\n");
      out.write("\t\t\t\t<h2 class=\"w3ls-hdg\">ADD/UPDATE SERVICE</h2>\n");
    ...
    if(aobj!=null)
    {
      out.write("\n");
      out.write("    <div class=\"form-group\">\n");
      out.write("<label for=\"Name\" class=\"col-sm-4 control-label\">Service Name</label>\n");
      out.write("    <div class=\"col-sm-8\">\n");
      out.write("<input type = \"text\" value = \"");
      out.print(aobj.get(1));
      out.write("\" name =\"servicename\" class=\"form-control1\" placeholder=\"Service Name\">\n");
      out.write("        </div></div>\n");
      out.write("    <div class=\"form-group\">\n");
      out.write("<label for=\"Name\" class=\"col-sm-4 control-label\">Section Name</label>\n");
      out.write("    <div class=\"col-sm-8\">\n");
      out.write("        <select name=\"sectionid\" class=\"form-control1\">\n");
      out.write("              ");
      ...
      out.write("        </div></div>\n");
      out.write("                                                            <div class=\"form-group\">\n");
      out.write("<label for=\"Name\" class=\"col-sm-4 control-label\">Department Name</label>\n");
      out.write("    <div class=\"col-sm-8\">\n");
      out.write(" <select name=\"departid\" class=\"form-control1\">\n");
      out.write("     \n");
      out.write("      ");
      ...
      out.write("        </div></div>\n");
      out.write("                                                            <div class=\"form-group\">\n");
      out.write("<label for=\"Name\" class=\"col-sm-4 control-label\">Doc.Required</label>\n");
      out.write("    <div class=\"col-sm-8\">\n");
      out.write("<input type = \"text\" value = \"");
      out.print(aobj.get(4));
      out.write("\" name =\"doc\" class=\"form-control1\" placeholder=\"Doc.Required\">\n");
      out.write("        </div></div>\n");
      out.write(" ");
}
    else
      ...
      out.write("<label for=\"Name\" class=\"col-sm-4 control-label\">Service Name</label>\n");
      out.write("    <div class=\"col-sm-8\">\n");
      out.write("<input type = \"text\" value = \"\" name =\"servicename\" class=\"form-control1\" placeholder=\"Service Name\">\n");
      out.write("        </div></div>\n");
      out.write("                                                            <div class=\"form-group\">\n");
      out.write("<label for=\"Name\" class=\"col-sm-4 control-label\">Section Name</label>\n");
      out.write("    <div class=\"col-sm-8\">\n");
      ...
      out.write("<label for=\"Name\" class=\"col-sm-4 control-label\">Doc.Required</label>\n");
      out.write("    <div class=\"col-sm-8\">\n");
      out.write("<input type = \"text\" value = \"\" name =\"doc\" class=\"form-control1\" placeholder=\"Doc.Required\">\n");
      out.write("        </div></div>");
}
      out.write("\n");
      out.write("<div class=\"col-sm-8\">\n");
      ...
      out.write("              <tr>\n");
      out.write("             <td>\n");
      out.write("                 <form name=\"selectbtn\" action=\"ServiceServlet\" method=\"post\">\n");
