<%-- 
    Document   : admin_chsngepassword
    Created on : Apr 18, 2017, 4:37:30 PM
...
<input type="text" name="adhar"  class="form-control1" placeholder="User Name"/>
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">	 <input type="password" name="newpassword"  class="form-control1" placeholder="New Password"/></div></div>

<div class="form-group">
<div class="col-sm-8">
    <input type = "Submit"  value="Change"  name="btn" onclick="return validateform()" class="btn-primary">
