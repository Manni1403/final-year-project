<%-- 
    Document   : userheader
    Created on : Apr 3, 2017, 5:56:34 PM
			...
			<div class="header-nav">
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
					   ...
					   <a class="navbar-brand" href="#"><img src="images/logo.jpg" width="300" height="100" /></a>
					</div>
					<!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
                                                        <li class="hvr-bounce-to-bottom active"><a href="user_myprofile.jsp">MyProfile</a></li>
                                                        <li class="hvr-bounce-to-bottom"><a href="user_applicationstatus.jsp">ApplicationStatus</a></li>
                                                        <li class="hvr-bounce-to-bottom"><a href="user_feedback.jsp">Feedback</a></li>
                                                        <li class="hvr-bounce-to-bottom"><a href="user_selectcity.jsp">ApplyNow</a></li>
                                                        <li class="hvr-bounce-to-bottom"><a href="user_changepassword.jsp">Settings</a></li>
		                                        <li class="hvr-bounce-to-bottom"><a href="loginservlet?btn=LOG OUT">Logout</a></li>
                                                        <li class="hvr-bounce-to-bottom"><a href="#"><%=session.getAttribute("user").toString()%></a></li>
						</ul>
					</div><!-- //navbar-collapse -->
				</nav>
			</div>
