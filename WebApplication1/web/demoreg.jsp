<%-- 
    Document   : demoreg
    Created on : Mar 15, 2017, 2:03:19 PM
...
<tr> <td > <b> Gender </b> </td> <td>  <input type = "radio" value = "M" name = "gen" checked
>Male
...
<tr> <td> <b> Password</b> </td> <td> <input type = "password" value = "" name =
"password"> </td>
 </tr>
<tr> <td>  <b>Confirm password </b> </td> <td> <input type="password" value=""
name="cpass">
 </td> </tr>
<tr> <td>
